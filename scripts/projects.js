    ...
    aside.innerHTML = ''+
      '<div class="project-messages" style="position:sticky; top:10px">' +
        ...
        '<div style="display:flex; gap:8px;">' +
          ...
          '<button class="p-but1" id="btn-send-msg">Send</button>' +
        '</div>' +
      '</div>';
